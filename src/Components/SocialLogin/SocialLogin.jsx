  ...
  return (
    <div>
      ...
      <div className="text-center flex justify-center gap-8">
        ...
        <button  onClick={handleGoogleLogin} className="btn btn-outline btn-warning border-0 border-b-4 mt-4 bg-gradient-to-r from-neutral-500 via-cyan-600 to-neutral-600 rounded shadow-xl bg-opacity-30 scale-110">
          <FaGoogle></FaGoogle>
        </button>
